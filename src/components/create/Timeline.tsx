...
export const Timeline = ({
    ...
    return (
        <div className="w-full h-full bg-white/90 dark:bg-slate-900/90 backdrop-blur rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 flex flex-col p-4 relative">
             {/* Controls */}
             <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <button 
                        onClick={() => onSeek(0)}
                        className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 flex items-center justify-center transition-all"
                    >
                        <SkipBack size={14} />
                    </button>
                    
                    <div className="font-mono text-xs font-semibold text-slate-700 dark:text-slate-300 ml-4">
             ...
             {/* Tracks Area */}
             <div className="flex-1 bg-slate-50 dark:bg-slate-950 rounded border border-slate-200 dark:border-slate-800 relative overflow-hidden group">
